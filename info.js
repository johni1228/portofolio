let info = {
  ...
  links: {
    github: "https://github.com/johni1228",
  ...
  experience: [
    {
      ...
      description:
        "Developed on-chain & off-chain governance protocol with MERCER-based tokens so that users are able to make decisions of adding new features and modifying current functionalities of the platform.",
      skills: ["Blockchain", "Smart contracts", "Solidity", "Web3.js", "React.js", "Typescript"]
    },
    {
      name: "NFT Development",
      place: "ZEROBILLBANK, Chiyoda, Japan",
      date: "February 2020 — October 2020",
      position: "Blockchain lead developer",
      description:
        "· Implemented NFT fractionalization so that users are able to co-won NFT and decide further steps like sale, auction, airdrop together.",
      skills: ["NFT", "Smart contracts", "Solidity", "IPFS", "Typescript", "Node.js", "Python"]
    },
    {
      name: "Blockchain developer",
      place: "Bitcoin Diamond, Singapore",
      date: "November 2018 — June 2019",
      position: "Full stack developer",
      description:
        "Developed and launched ERC-20 token TAHU and implemented Yield Farming. TAHU team had been joined to moved forward to launch NFT(ERC-1155 Dark Matter Ltd).",
      skills: ["Blockchain", "Smart contracts", "Solidity", "React.js", "Web3.js"]
    },
    {
      name: "Building Defi",
      place: "CoinJar, Melbourne, Australia",
      date: "February 2018 — June 2018",
      position: "Blockchain Developer",
      description:
        "Developed Smart Contract for Gelato DeFi token as a Smart Contract Developer",
  ...
  recommendations: [
    {
      title:
        "In his internship, Xin John has demonstrated excellent learning ability, and with a dedicated, task oriented approach, he was able to complete his assignment ahead of time.",
      author: "Dr. Mervyn G. Maistry",
      position: "CEO",
      company: "konfidio",
    ...
    },
    {
      ...
      author: "Ashok Sanghani",
      position: "CTO",
      company: "Bitcoin Diamond,",
      location: "Singapore"
    },
    {
      title:
